		...
		switch (location.pathname) {
			case '/contacts':
				return {
					...
					description: "Estamos aquí para responder tus dudas y ayudarte en lo que necesites. No dudes en contactarnos."
				};
			case '/faq':
				return {
					title: "Preguntas Frecuentes",
					subtitle: "Todo lo que necesitas saber",
					description: "Encuentra respuestas a las preguntas más comunes sobre el Congreso Magno 3.0."
				};
			case '/register':
				return {
					title: "Congreso Magno 3.0",
					subtitle: "Únete a la élite de la odontología",
					description: "Completa tu registro para acceder a talleres exclusivos, ponencias internacionales y las últimas innovaciones en tecnología dental."
				};
			default:
				return {
					title: "Congreso Magno 3.0",
					subtitle: "Únete a la élite de la odontología",
					description: "Bienvenido al evento más importante de odontología del año."
				};
		}
	};
