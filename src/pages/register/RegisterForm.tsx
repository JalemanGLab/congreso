...
import SelectData from '@/components/shared/SelectData/SelectData';
   ...
   const { 
    ...
    return (
        <div className="w-full min-h-screen bg-gray-100 flex flex-col">
            ...
            <div className="w-full h-[325px] flex flex-col bg-gradient-to-b gap-3 from-[#000000] to-[#333333] p-10">
                <div className="w-full text-white text-4xl font-bold">Congreso Magno 3.0</div>
                <div className="text-[#A8A8A8] text-xl font-medium">Únete a la élite de la odontología</div>
                <div className="text-[#A8A8A8] text-sm">Completa tu registro para acceder a talleres exclusivos, ponencias internacionales y las últimas innovaciones en tecnología dental.</div>
            </div>
            <div className="w-full bg-white flex justify-center pb-20">
               <div className="w-[900px] flex flex-col justify-center items-center bg-[#f1f1f1] rounded-lg -mt-16 md:-mt-32 p-10 gap-10">
